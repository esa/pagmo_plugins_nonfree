...
BOOST_PYTHON_MODULE(core)
{
    ...
    snopt7_.def("set_integer_option", &pagmo::snopt7::set_integer_option, pg::snopt7_set_integer_option_docstring().c_str(), (bp::arg("name"), bp::arg("value")));
    snopt7_.def("set_numeric_option", &pagmo::snopt7::set_numeric_option, pg::snopt7_set_numeric_option_docstring().c_str(), (bp::arg("name"), bp::arg("value")));
    ...
    // We expose the additional constructor
    worhp_.def(bp::init<bool, std::string>(
        (bp::arg("screen_output") = false, bp::arg("library") = "/usr/local/lib/")));
