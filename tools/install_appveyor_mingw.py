...
if is_python_build:
    ...
    os.makedirs('build')
    os.chdir('build')
    run_command(r'cmake -G "MinGW Makefiles" .. -DBoost_SYSTEM_LIBRARY_DEBUG=c:\\local\\lib\\libboost_system-mgw62-mt-1_63.dll -DBoost_FILESYSTEM_LIBRARY_DEBUG=c:\\local\\lib\\libboost_filesystem-mgw62-mt-1_63.dll -DCMAKE_BUILD_TYPE=Debug -DPAGMO_PLUGINS_NONFREE_BUILD_TESTS=yes ' +
